/**
 * ViewToggle Component - Card/Table view toggle buttons
 * @feature 027-vendor-view-toggle
 */

import { cn } from '@/lib/utils';
import { LayoutGrid, Table2 } from 'lucide-react';
import type { VendorViewMode } from '@/types/vendor-table';

interface ViewToggleProps {
  /** Current active view mode */
  activeView: VendorViewMode;
  /** Callback when view is changed */
  onViewChange: (view: VendorViewMode) => void;
